                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <a href="">
                            <div class="DWel1stImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/800/cpsprodpb/14B2A/production/_126587748_canada_suspects_jpeg.png" alt="">
                                <div class="Desc">
                        ...
                        <div class="row">
                            <div class="col-lg-12"><a href="">
                                    <div class="DWel2ndImg1">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/400/cpsprodpb/844C/production/_126586833_sunaktrussgetty.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-12">
                                <a href="">
                                    <div class="DWel2ndImg2">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/400/cpsprodpb/1192A/production/_126587917_peace-before-pieces.jpg" alt="">
                                        <div class="Desc">
                    ...
                    <div class="col-lg-3">
                        <div class="row">
                            <div class="col-lg-12"><a href="">
                                    <div class="DWel2ndImg1">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/400/cpsprodpb/1DA4/production/_126588570_indacc1.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-12">
                                <a href="">
                                    <div class="DWel2ndImg2">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/400/ibroadcast/images/live/p0/cx/r1/p0cxr1c4.jpg" alt="">
                                        <div class="Desc">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <a href="">
                            <div class="DNewsImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/1756E/production/_126589559_mediaitem126589557.jpg" alt="">
                                <div class="Desc">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <a href="">
                            <div class="DSportsImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/26A0/production/_126588890_gettyimages-1420778570.jpg" alt="">
                                <div class="Desc">
                    ...
                    <div class="col-lg-4">
                        <a href="">
                            <div class="DSportsImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/F2ED/production/_126498126_gettyimages-1390291613.jpg" alt="">
                                <div class="Desc">
                    ...
                    <div class="col-lg-4">
                        <a href="">
                            <div class="DSportsImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/17C6C/production/_126588379_nick_kyrgios_getty7.jpg" alt="">
                                <div class="Desc">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <a href="">
                            <div class="card" style="width: 25rem;">
                                <img src="https://ychef.files.bbci.co.uk/432x243/p0cy0xqb.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <a href="">
                            <div class="card" style="width: 25rem;">
                                <img src="https://ychef.files.bbci.co.uk/432x243/p0cxzq5q.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <a href="">
                            <div class="card" style="width: 25rem;">
                                <img src="https://ychef.files.bbci.co.uk/432x243/p0cx8dbr.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <a href="">
                            <div class="DAsiaImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/1DA4/production/_126588570_indacc1.jpg" alt="">
                                <div class="Desc">
                                    <h2>Inside India's 'factories of death'</h2>
                    ...
                    <div class="col-lg-3">
                        <a href="">
                            <div class="DAsiaImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/E80F/production/_126570495_p0cy1zv3.jpg" alt="">
                                <div class="Desc">
                    ...
                    <div class="col-lg-3">
                        <a href="">
                            <div class="DAsiaImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/F8C8/production/_126588636_cyrusmistry.jpg" alt="">
                                <div class="Desc">
                    ...
                    <div class="col-lg-3">
                        <a href="">
                            <div class="DAsiaImg">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/16182/production/_126589409_murphy's.jpg" alt="">
                                <div class="Desc">
                    ...
                    <div class="col-lg-8">
                            ...
                            <div class="col-lg-12">
                                <a href="">
                                    <div class="DEditorsImg">
                                        <img class="" src="https://ychef.files.bbci.co.uk/width/790/p0cyk1c3.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors1stImg2">
                                        <img class="img-fluid" src="https://ychef.files.bbci.co.uk/width/790/p0cxhcps.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors2ndImg3">
                                        <img class="img-fluid" src="https://ychef.files.bbci.co.uk/width/790/p0cyf7y5.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors3rdImg4">
                                        <img class="img-fluid" src="https://ychef.files.bbci.co.uk/width/790/p0cyc5zs.jpg" alt="">
                                        <div class="Desc">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors1stImg2">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/ibroadcast/images/live/p0/cw/ng/p0cwng9p.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors2ndImg3">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/2421/production/_126594290_393338.jpg" alt="">
                                        <div class="Desc">
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors3rdImg4">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/0C25/production/_126590130_hi033719866.jpg" alt="">
                                        <div class="Desc">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <a href="">
                            <div class="card" style="width: 25rem;">
                                <img src="https://ychef.files.bbci.co.uk/624_351/p0cx83wm.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <a href="">
                            <div class="card" style="width: 25rem;">
                                <img src="https://ychef.files.bbci.co.uk/624_351/p0cvtpfv.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <a href="">
                            <div class="card" style="width: 25rem;">
                                <img src="https://ychef.files.bbci.co.uk/624_351/p0ctd3sr.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                <a href="">
                                    <div class="DTechBusImg">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/7A67/production/_126453313_image00005.jpg" alt="">
                                        <div class="Desc">
                                            <h6 class="country">BUSINESS</h6>
                        ...
                        <div class="DNewTech">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="">
                                        <div class="DTechBusImg">
                                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/DC4E/production/_126589365_profile_machitakahashi_20210921_white2.jpg" alt="">
                                            <div class="Desc">
                                                <h6 class="country">BUSINESS</h6>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <a href="">
                            <div class="DVideo">
                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/800/cpsprodpb/75D0/production/_126606103_p0cyndh7.jpg" alt="">
                                <div class="Desc">
                                    <h2>How many people can Earth handle?</h2>
                                    <p>BBC Future tales a look at one of the most controversial issues of our
                                        time.</p>
                            ...
                            <div class="container">
                                ...
                                <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="ex1-tab-1" data-mdb-toggle="tab" href="#ex1-tabs-1" role="tab" aria-controls="ex1-tabs-1" aria-selected="true">Recomended</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="ex1-tab-2" data-mdb-toggle="tab" href="#ex1-tabs-2" role="tab" aria-controls="ex1-tabs-2" aria-selected="false">Latest</a>
                                    </li>
                                </ul>
                                <!-- Tabs navs -->
                                ...
                                <div class="tab-content" id="ex1-content">
                                    <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                                        <div class="owl-carousel owl-theme">
                                            <div class="item">
                                                <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/11B41/production/_126631527_p0cz2spj.jpg" alt="">
                                                <div class="OwlDesc">
                        ...
                        <div class="DEditors2ndSec1">
                            <a href="">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="DEditorsImg">
                                            <img src="https://ichef.bbc.co.uk/wwhp/144/ibroadcast/images/live/p0/7z/nr/p07znrkz.jpg" alt="" class="img-fluid img-bullet">
                                        </div>
                                    </div>
                                    <div class="col-9">
                                        <div class="DEditorsTxt">
                        ...
                        <div class="DEditors2ndSec2">
                            <a href="">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="DEditorsImg">
                                            <img src="https://ichef.bbc.co.uk/wwhp/144/ibroadcast/images/live/p0/2x/05/p02x05mf.jpg" alt="" class="img-fluid img-bullet">
                                        </div>
                                    </div>
                                    <div class="col-9">
                                        <div class="DEditorsTxt">
                        ...
                        <div class="DEditors2ndSec3">
                            <a href="">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="DEditorsImg">
                                            <img src="https://ichef.bbc.co.uk/wwhp/144/ibroadcast/images/live/p0/81/0t/p0810t8r.jpg" alt="" class="img-fluid img-bullet">
                                        </div>
                                    </div>
                                    <div class="col-9">
                                        <div class="DEditorsTxt">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="">
                                    <div class="DEditorsImg">
                                        <img class="imgMain" src="https://ichef.bbc.co.uk/wwhp/999/cpsprodpb/125DD/production/_126592257_gettyimages-1317488623.jpg" alt="">
                                        <div class="Desc">
                                            <h2>How many people can Earth handle?</h2>
                                            <p>BBC Future tales a look at one of the most controversial issues of our
                                                time.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors1stImg2">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/B45B/production/_126617164_alangarnertreaclewalkercreditdavidheke.jpg" alt="">
                                        <div class="Desc">
                                            <h2>The neglected trait that drives success</h2>
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors2ndImg3">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/1174A/production/_126589417_jetstar.jpg" alt="">
                                        <div class="Desc">
                                            <h2>The desert people who buit a US city</h2>
                                            <p>THe city's name pays homeage to their engineering prowess</p>
                                            <h6 class="country">TRAVEL</h6>
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors3rdImg4">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/ED89/production/_126590806_gettyimages-1242261648.jpg" alt="">
                                        <div class="Desc">
                                            <h2>Brendan Fraser's 'Oscar worthy' role</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <a href="">
                                    <div class="DEditors2ndImg3">
                                        <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/304/cpsprodpb/A565/production/_126614324_mediaitem126614097.jpg" alt="">
                                        <div class="Desc">
                                            <h2>Drones capture avalanche live in Frozed Planet II</h2>
        ...
        <div class="DTechnology">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="DTechImg">
                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/D309/production/_126452045_img_6873.jpg" alt="">
                            <div class="Desc">
                                <h2>How many people can Earth handle?</h2>
                                <h6 class="country">FUTURE</h6>
                            </div>
        ...
        <div class="DWorldPhoto">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="DWorldImg">
                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/174F8/production/_126608459_1_queen_getty.jpg" alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="DWorldImg2">
                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/184B1/production/_126550599_02.jpg" alt="">
                            <i class="fas fa-camera"></i>
                            <div class="Desc">
                                <h2>How many people can Earth handle?</h2>
                                <h6 class="country">FUTURE</h6>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="DWorldRow2Img">
                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/0D08/production/_126563330_179cd99fab1ed11ae221efddc8f08ff1617cf9e8.jpg" alt="">
                            <div class="Desc">
                                <h2>How many people can Earth handle?</h2>
                                <h6 class="country">FUTURE</h6>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="DWorldRow2Img">
                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/15C92/production/_126543298_28.jpg" alt="">
                            <div class="Desc">
                                <h2>How many people can Earth handle?</h2>
                                <h6 class="country">FUTURE</h6>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="DWorldRow2Img">
                            <img class="img-fluid" src="https://ichef.bbc.co.uk/wwhp/624/cpsprodpb/12037/production/_126538737_gallery_9_mikhail_gorbachev_split_getty.jpg" alt="">
                            <div class="Desc">
                                <h2>How many people can Earth handle?</h2>
                                <h6 class="country">FUTURE</h6>
                            </div>
